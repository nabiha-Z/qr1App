...
/* Chart-js (#lineChart1) */
	...
	gradientStroke1.addColorStop(0, '#1cbb80');

	var gradientStroke2 = myCanvasContext.createLinearGradient(0, 0, 0, 190);
	gradientStroke2.addColorStop(0, '#1cbb80');
	...
	var myChart = new Chart(myCanvas, {
		...
		options: {
			...
			tooltips: {
				mode: 'index',
				titleFontSize: 12,
				titleFontColor: '#1cbb80',
				bodyFontColor: '#1cbb80',
